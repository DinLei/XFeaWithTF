    ...
    def StringToRecord(self, input_file, output_file):
        ...
        for line in open(input_file, 'r'):
            ...
            for fieldid in self.sparse_field:
                ...
                feature['sparse_id_in_field_' + str(fieldid)] = tf.train.Feature(
                    int64_list=tf.train.Int64List(value=feature_id_list))
                feature['sparse_val_in_field_' + str(fieldid)] = tf.train.Feature(
                    float_list=tf.train.FloatList(value=feature_val_list))
